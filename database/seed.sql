-- ============================================================
-- EventHub Seed Data (MySQL 8)
-- 16 Tier-2 & Tier-3 City Vendors & Demo Accounts
-- ============================================================
USE eventhub_db;

-- 1. Demo Users (Default Password for all: Password123!)
...
-- 2. Vendors Data (Patna, Gaya, Muzaffarpur, Bhagalpur, Begusarai, Nalanda, Sheikhpura)
...
-- 3. Venue Details (Capacities & Rooms)
...
-- 4. Vendor Services / Packages (explicit ids keep this INSERT idempotent on re-run)
INSERT INTO vendor_services (id, vendor_id, service_name, description, price, price_type, is_popular) VALUES
(1, 1, 'Full Grand Royal Venue Package', 'Access to Main Hall, Lawn, 12 AC Rooms, Stage & Chairs setup for 24 hours', 70000.00, 'fixed', TRUE),
(2, 1, 'Half Day / Sangeet Package', 'Access to Banquet Hall and 4 Rooms for 8 hours', 45000.00, 'fixed', FALSE),
(3, 2, 'Heritage Destination Wedding Package', 'Complete resort with lawn, banquet, and 10 deluxe suites for 24 hours', 65000.00, 'fixed', TRUE),
(4, 3, 'Royal Mithila Classic Package', 'Main Hall, 8 AC rooms, and dining area with basic lighting', 55000.00, 'fixed', TRUE),
(5, 4, 'Silk City Standard Hall Package', 'AC Banquet Hall with 6 guest rooms and stage lighting', 50000.00, 'fixed', TRUE),
(6, 5, 'Royal Bihari & Mughlai Gold Buffet', 'Welcome drinks, 4 Starters, 6 Main courses (incl. Paneer Lababdar, Dal Makhani, Litti Chokha special), 3 Desserts for 250 pax', 90000.00, 'package', TRUE),
(7, 5, 'Silver Classic Buffet', 'Welcome drink, 2 Starters, 4 Main courses, 2 Desserts for 200 pax', 70000.00, 'package', FALSE),
(8, 6, 'Magadh Pure Veg Royal Thali Buffet', 'Authentic vegetarian culinary feast with 5 live counters and Rajasthani/Bihari sweets for 200 pax', 75000.00, 'package', TRUE),
(9, 7, 'Grand Floral & Royal Mandap Theme', 'Exotic flower stage backdrop, crystal entryway arch, LED mood lights, and floral sofa set', 40000.00, 'fixed', TRUE),
(10, 7, 'Contemporary Pastel Theme Decor', 'Geometric arch, fairy light curtain, pastel draping, and selfie photo-booth', 32000.00, 'fixed', FALSE),
(11, 8, 'Utsav Signature Stage & Entry Decor', 'Customizable flower stage, carpet walkway, entrance gate with lighting', 30000.00, 'fixed', TRUE),
(12, 9, 'Cinematic 4K Wedding & Pre-wedding Package', '2 Candid photographers, 2 Cinematographers, Drone camera, Teaser video, Full length film, Premium 50-page Photo Album', 35000.00, 'fixed', TRUE),
(13, 10, 'Moments Classic Photo & Video Package', '1 Candid photographer, 1 Traditional videographer, High-res digital gallery, Photo Album', 28000.00, 'fixed', TRUE),
(14, 11, 'Full Night DJ & Laser Truss Setup', 'High-wattage JBL sound, Moving heads, Fog machine, DJ console, LED dance floor, Bollywood DJ artist', 25000.00, 'fixed', TRUE),
(15, 12, 'Sangeet Party DJ Setup', 'Professional sound system, LED par cans, Wireless mics, Popular dance playlist curation', 20000.00, 'fixed', TRUE),
(16, 13, 'HD Airbrush Bridal Glamour Package', 'Airbrush makeup, Hair styling, Draping, Eyelashes, Pre-bridal facial consultation', 18000.00, 'fixed', TRUE),
(17, 14, 'Begusarai Grand Venue Day Rental', 'Complete banquet and 6 rooms for 24 hours', 45000.00, 'fixed', TRUE),
(18, 15, 'Nalanda Vihar Destination Grounds', 'Lawn, Courtyard, and 8 rooms for wedding celebrations', 48000.00, 'fixed', TRUE),
(19, 16, 'Sheikhpura Celebration Hall Day Pass', 'Banquet hall and 4 rooms for full day', 35000.00, 'fixed', TRUE)
